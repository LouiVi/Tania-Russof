...
https://youtu.be/x4HVBRxVGY0?si=CWhY9RNueVFt_HKq
var videoIds = [
    "x4HVBRxVGY0", "AK31U2f1nl0",
...
function OnStart()
{
	...
	this.img = ui.addImage( lay, "Img/Tania Russof.png", "Avatar" );
	...
	title = app.AddText( lay, "Tania Russof", 1, -1, "Bold" )
